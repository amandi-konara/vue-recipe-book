...
<template>
  <router-link
    :to="`/recipe/${recipe.id}`"
    class="cursor-pointer bg-white dark:bg-gray-700 rounded-2xl shadow-md overflow-hidden hover:shadow-xl transition-shadow duration-300"
  >
    <img
      :src="recipe.image"
      :alt="recipe.name"
    ...
    <div class="p-4">
      <h2 class="text-lg font-bold mb-1 truncate dark:text-white">{{ recipe.name }}</h2>
